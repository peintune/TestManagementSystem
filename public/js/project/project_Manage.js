 ...
 */
Ext.namespace("pinganfang.ats.project");


pinganfang.ats.project.Manage = function () {
    var deviceWindow;
        ...
        listeners: {
            edit: function (e) {
                if (Global.userRole == 1 || e.context.record.data.lastOwner == Global.username) {
                    ...
                    Ext.Msg.alert('Error', "You have no permission to handle this device");
                }
    ...
    if (typeof (projectWindow) == "undefined") {
        projectWindow = Ext.create("Ext.window.Window", {
            title: '项目管理',
            id: "projectWindow",
            layout: "column",
            columnWidth: .7,
